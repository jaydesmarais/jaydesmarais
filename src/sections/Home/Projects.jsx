...
import healthAppImages from 'images/healthApp/photos.jsx'
import liftLogImages from 'images/liftLog/photos.jsx'
import siteImages from 'images/site/photos.jsx'
        ...
        <StickyContainer>
          ...
          <ProjectGraphics>
            ...
            {siteImages.map((img, i) => {
              return (
                <img key={i} style={{ width: "100%" }} src={img} alt={img} />
              );
            })}
          </ProjectGraphics>
        </StickyContainer>
          ...
          <ProjectGraphics>
            ...
            <StyledParallax translateY={[0, -150]}>
              <ProjectGraphics className='internal'>
                {healthAppImages.sort(() => Math.random() - 0.5).map((img, i) => {
                  return (
                    <img
                      key={i}
                      style={{ width: "100%" }}
      ...
      <ProjectSection>
        <StickyContainer className='internal'>
          ...
          <ProjectGraphics>
            ...
            <StyledParallax translateY={[0, -150]}>
              <ProjectGraphics className='internal'>
                {liftLogImages.sort(() => Math.random() - 0.5).map((img, i) => {
                  return (
                    <img
                      key={i}
                      style={{ width: "100%" }}
